  ...
  return (
    <>
      ...
      <Box height={'50vh'} marginTop={'10'}>
        <MapContainer center={[point.lat, point.lng]} zoom={4} scrollWheelZoom={true}>
          <TileLayer
  ...
  return (
    <>
      ...
      <FormControl as={GridItem}>
        ...
        <NumberInput defaultValue={1} precision={1} step={0.1} min={1} max={4.5}
          name="maturityGroup"
          id="maturityGroup">
          <NumberInputField />
          <NumberInputStepper>
  ...
  return (
    <>
      ...
      <FormControl as={GridItem}>
        ...
        <NumberInput defaultValue={20} precision={0} step={1} min={20} max={50}
      ...
      <FormControl as={GridItem}>
        ...
        <NumberInput defaultValue={25} precision={0} step={25} min={25} max={100}
